...
namespace RRM.ComplexRecipes
{
    public static class ComplexRecipesTable
    {
        ...
        public static void RegisterAll()
        {
            ...
            ElectronicsRecipes_CR();
            DeployablesRecipes_CR();
            EquipmentRecipes_CR();
            ToolsRecipes_CR();
            VehiclesRecipes_CR();
            UpgradeModulesRecipes_CR();
            BasePiecesRecipes_CR();
            BaseExteriorModulesRecipes_CR();
            BaseInteriorPiecesRecipes_CR();
        ...
        public static void AdvancedMaterialsRecipes_CR()
        {
            ...
            RecipeData benzeneRecipe = new(
                new Ingredient(TechType.BloodOil, 2),
                new Ingredient(TechType.Quartz, 1));
        ...
        public static void BaseExteriorModulesRecipes_CR()
        {
            // solar panel recipe
