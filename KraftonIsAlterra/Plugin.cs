...
namespace KraftonIsAlterra
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static void InitializeLocalization()
        {
            ...
            // check for the lists, clear them if they contain data. Usefull if user decides to change their game's language between sessions.
            ...
            // populate the lists with localized words based on user's language
            SetLocalizedLists();
